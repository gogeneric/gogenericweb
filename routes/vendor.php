...
Route::group(['namespace' => 'Vendor', 'as' => 'vendor.'], function () {
    ...
    Route::group(['middleware' => ['vendor']], function () {
        ...
        Route::group(['prefix' => 'purchase-order', 'as' => 'purchase-order.', 'middleware' => ['module:purchase_order']], function () {
            ...
            Route::get('payment/{purchaseOrder}', 'PurchaseOrderController@payment')->name('payment');
            Route::post('purchase-orders/{purchaseOrder}/receive', 'PurchaseOrderController@receiveItems')
