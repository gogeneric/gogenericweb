...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin', 'current-module']], function () {
        ...
        Route::group(['prefix' => 'purchase-order', 'as' => 'purchase-order.', 'middleware' => ['module:purchase_order']], function () {
            Route::get('/', 'PurchaseOrderController@index')->name('index');
            Route::get('create', 'PurchaseOrderController@create')->name('create');
            Route::get('show/{purchaseOrder}', 'PurchaseOrderController@show')->name('show');
            Route::post('update/{purchaseOrder}', 'PurchaseOrderController@update')->name('update');
            Route::delete('destroy/{purchaseOrder}', 'PurchaseOrderController@destroy')->name('destroy');
        });
        ...
        Route::group(['prefix' => 'super-admin-stocks', 'as' => 'super-admin-stocks.', 'middleware' => ['module:super_admin_stock']], function () {
            Route::get('/', 'SuperAdminStockController@index')->name('index');
            Route::get('create', 'SuperAdminStockController@create')->name('create');
            Route::post('store', 'SuperAdminStockController@store')->name('store');
            Route::get('edit/{id}', 'SuperAdminStockController@edit')->name('edit');
            Route::put('update/{id}', 'SuperAdminStockController@update')->name('update');
            Route::delete('delete/{id}', 'SuperAdminStockController@destroy')->name('delete');
            Route::get('status/{id}/{status}', 'SuperAdminStockController@status')->name('status');
            Route::get('bulk-import', 'SuperAdminStockController@bulk_import_index')->name('bulk-import');
            Route::post('bulk-import', 'SuperAdminStockController@bulk_import_data');
            Route::get('bulk-export', 'SuperAdminStockController@bulk_export_data')->name('bulk-export');
            Route::get('get-categories', 'SuperAdminStockController@getCategories')->name('get-categories');
            Route::get('download-template', 'SuperAdminStockController@downloadTemplate')->name('download-template');
        });
...
Route::get('super-admin-stocks/download-template', 'SuperAdminStockController@downloadTemplate')->name('admin.super-admin-stocks.download-template');
