...
class VendorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $store->drug_license_number = $request->drug_license_number;
        $store->drug_license_expiry = $request->drug_license_expiry;
        $store->store_contact_person_number = $request->store_contact_person_number;
        $store->pan_gst_number = $request->pan_gst_number;
        
        if ($request->hasFile('form_20_21')) {
            $store->form_20_21 = Helpers::upload('store/form_20_21/', 'pdf', $request->file('form_20_21'));
        }
        
        if ($request->hasFile('pan_gst_upload')) {
            $store->pan_gst_upload = Helpers::upload('store/pan_gst/', 'pdf', $request->file('pan_gst_upload'));
        }
        
        if ($request->hasFile('owner_photo')) {
            $store->owner_photo = Helpers::upload('store/owner/', 'png', $request->file('owner_photo'));
        }
    ...
    public function update(Request $request, Store $store)
    {
        ...
        if ($request->hasFile('form_20_21')) {
            $store->form_20_21 = Helpers::update('store/form_20_21/', $store->form_20_21, 'pdf', $request->file('form_20_21'));
        }
        
        if ($request->hasFile('pan_gst_upload')) {
            $store->pan_gst_upload = Helpers::update('store/pan_gst/', $store->pan_gst_upload, 'pdf', $request->file('pan_gst_upload'));
        }
        
        if ($request->hasFile('owner_photo')) {
            $store->owner_photo = Helpers::update('store/owner/', $store->owner_photo, 'png', $request->file('owner_photo'));
        }
    ...
    public function destroy(Request $request, Store $store)
    {
        ...
        // Delete pharmacy-specific files
        Helpers::check_and_delete('store/form_20_21/' , $store->form_20_21);
        Helpers::check_and_delete('store/pan_gst/' , $store->pan_gst_upload);
        Helpers::check_and_delete('store/owner/' , $store->owner_photo);
