    ...
    <div class="content container-fluid">
        ...
        <div class="card mt-4">
            <div class="card-header">
                <h5 class="mb-0">{{ translate('Stock Transaction History') }}</h5>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-borderless table-thead-bordered">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="border-0 text-center">{{ translate('Qty Change') }}</th>
                                <th class="border-0">{{ translate('Old Stock') }}</th>
                                <th class="border-0">{{ translate('New Stock') }}</th>
                                <th class="border-0">{{ translate('Source') }}</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($transaction->purchase_order_id)
                                        {{ translate('PO') }} #{{ $transaction->purchase_order_id }}
                                    @elseif($transaction->user_id)
                                        {{ translate('Manual') }} ({{ $transaction->user?->name ?? 'System' }})
                                    @else
                                        {{ translate('System') }}
                                    @endif
                                </td>
                            ...
                            @empty
                            <tr>
                                <td colspan="6" class="text-center">{{ translate('No stock transactions found') }}</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
