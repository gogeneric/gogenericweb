        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <!-- End AddOn -->
                    @if (\App\CentralLogics\Helpers::module_permission_check('super_admin_stock'))
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/super-admin-stocks*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                               title="{{ translate('Super Admin Stocks') }}">
                                <i class="tio-battery-vertical nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate text-capitalize">{{ translate('Super Admin Stocks') }}</span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display:{{ Request::is('admin/super-admin-stocks*') ? 'block' : 'none' }}">
                                <li class="nav-item {{ Request::is('admin/super-admin-stocks/create') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('admin.super-admin-stocks.create') }}"
                                       title="{{ translate('Add New Stock') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{ translate('Add New Stock') }}</span>
                                    </a>
                                </li>
                                <li class="nav-item {{ Request::is('admin/super-admin-stocks') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('admin.super-admin-stocks.index') }}"
                                       title="{{ translate('Stock List') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{ translate('Stock List') }}</span>
                                    </a>
                                </li>
                                <li class="nav-item {{ Request::is('admin/super-admin-stocks/bulk-import') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('admin.super-admin-stocks.bulk-import') }}"
                                ...
                                <li class="nav-item {{ Request::is('admin/super-admin-stocks/bulk-export') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('admin.super-admin-stocks.bulk-export') }}"
                    ...
                    <!-- Unit -->
                    @if (\App\CentralLogics\Helpers::module_permission_check('purchase-order'))
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/purchase-order*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.purchase-order.index') }}" title="{{ translate('Purchase Order') }}">
