 ...
 alt="Logo">
            ...
            <div class="navbar-vertical-content text-capitalize bg--005555" id="navbar-vertical-content">
                ...
                @endif
                    ...
                    @if(\App\CentralLogics\Helpers::employee_module_permission_check('purchase_order'))
                    <li class="navbar-vertical-aside-has-menu {{Request::is('store-panel/purchase-order*')?'active':''}}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                            href="{{route('vendor.purchase-order.index')}}" title="{{translate('messages.purchase_orders')}}"
                        >
                            <i class="tio-shopping-cart nav-icon"></i>
                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                {{translate('messages.purchase_orders')}}
                            </span>
                        </a>
                    </li>
                    @endif
