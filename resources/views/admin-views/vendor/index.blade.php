                            ...
                            <div class="row g-3">
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="text" name="drug_license_number" id="drug_license_number" class="form-control" placeholder="{{translate('messages.drug_license_number')}}" value="{{old('drug_license_number')}}">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="drug_license_expiry">{{translate('messages.drug_license_expiry_date')}}</label>
                                        <input type="date" name="drug_license_expiry" id="drug_license_expiry" class="form-control" value="{{old('drug_license_expiry')}}">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="store_contact_person_number">{{translate('messages.store_contact_person_number')}}</label>
                                        <input type="tel" name="store_contact_person_number" id="store_contact_person_number" class="form-control" placeholder="{{translate('messages.Ex:')}} 017********" value="{{old('store_contact_person_number')}}">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="pan_gst_number">{{translate('messages.pan_gst_number')}}</label>
                                        <input type="text" name="pan_gst_number" id="pan_gst_number" class="form-control" placeholder="{{translate('messages.pan_gst_number')}}" value="{{old('pan_gst_number')}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="account_type" id="account_type" class="form-control js-select2-custom">
                                            <option value="savings">{{translate('messages.savings')}}</option>
                                            <option value="current">{{translate('messages.current')}}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="text" name="account_number" id="account_number" class="form-control" placeholder="{{translate('messages.account_number')}}" value="{{old('account_number')}}">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="bank_name">{{translate('messages.bank_name')}}</label>
                                        <input type="text" name="bank_name" id="bank_name" class="form-control" placeholder="{{translate('messages.bank_name')}}" value="{{old('bank_name')}}">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="ifsc_code">{{translate('messages.ifsc_code')}}</label>
                                        <input type="text" name="ifsc_code" id="ifsc_code" class="form-control" placeholder="{{translate('messages.ifsc_code')}}" value="{{old('ifsc_code')}}">
                                    </div>
                                </div>
                            </div>
                        </div>
