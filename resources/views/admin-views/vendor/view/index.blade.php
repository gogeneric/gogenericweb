            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    <div class="resturant--info-address">
                        ...
                        <div class="mt-3">
                            <h5>{{translate('messages.owner_photo')}}</h5>
                            <div class="mt-2 text-center">
                                <img src="{{ asset('storage/app/public/store/owner') . '/' . $store->owner_photo }}"
                                alt="{{translate('messages.owner_photo')}}" class="img-fluid rounded" style="max-width: 100%; max-height: 200px;">
                            </div>
                        </div>
                        @endif
                    </div>
            ...
            <div class="card h-100">
                <div class="card-header">
                    <h5 class="card-title m-0 d-flex align-items-center">
                        ...
                        <span class="ml-1">{{translate('messages.pharmacy_information')}}</span>
                    </h5>
                </div>
                <div class="card-body">
                    <div class="resturant--info-address">
                        <ul class="address-info address-info-2 list-unstyled list-unstyled-py-3 text-dark">
                            @if($store->drug_license_number)
                            <li>
                                <span>
                                    <i class="tio-document-text-outlined nav-icon"></i>
                                    <strong>{{translate('messages.drug_license_number')}} : </strong>
                                </span>
                                <span>
                            ...
                            @if($store->drug_license_expiry)
                            <li>
                                <span>
                                    <i class="tio-calendar nav-icon"></i>
                                    <strong>{{translate('messages.drug_license_expiry_date')}} : </strong>
                                </span>
                                <span>
                                    {{$store->drug_license_expiry}}
                                </span>
                            </li>
                            @endif

                            @if($store->store_contact_person_number)
                            <li>
                                <span>
                                    <i class="tio-call-talking nav-icon"></i>
                                    <strong>{{translate('messages.store_contact_person_number')}} : </strong>
                                </span>
                                <span>
                                    <a href="tel:{{$store->store_contact_person_number}}">{{$store->store_contact_person_number}}</a>
                                </span>
                            </li>
                            @endif

                            @if($store->pan_gst_number)
                            <li>
                                <span>
                                    <i class="tio-credit-card-outlined nav-icon"></i>
                                    <strong>{{translate('messages.pan_gst_number')}} : </strong>
                                </span>
                                <span>
                                    {{$store->pan_gst_number}}
                                </span>
                            </li>
                            @endif
                            ...
                            <li>
                                <span>
                                    ...
                                    <strong>{{translate('messages.form_20_21')}} : </strong>
                                </span>
                                <span>
                                    <a href="{{asset('storage/app/public/store/form_20_21')}}/{{$store->form_20_21}}" target="_blank" class="text-primary">{{translate('messages.view_file')}}</a>
                                </span>
                            </li>
                            @endif
                            ...
                            <li>
                                <span>
                                    <i class="tio-file-text-outlined nav-icon"></i>
                                    <strong>{{translate('messages.pan_gst_upload')}} : </strong>
                                </span>
                                <span>
                                    <a href="{{asset('storage/app/public/store/pan_gst')}}/{{$store->pan_gst_upload}}" target="_blank" class="text-primary">{{translate('messages.view_file')}}</a>
                                </span>
                            </li>
                            @endif
                        </ul>
            ...
            <div class="card h-100">
                <div class="card-header">
                    <h5 class="card-title m-0 d-flex align-items-center">
                        ...
                        <span class="ml-1">{{translate('messages.bank_account_information')}}</span>
                    </h5>
                </div>
                <div class="card-body">
                    <div class="resturant--info-address">
                        <ul class="address-info address-info-2 list-unstyled list-unstyled-py-3 text-dark">
                            @if($store->account_type)
                            <li>
                                <span>
                                    <i class="tio-category-outlined nav-icon"></i>
                                    <strong>{{translate('messages.account_type')}} : </strong>
                                </span>
                                <span>
                                    {{translate('messages.'.$store->account_type)}}
                                </span>
                            </li>
                            @endif
                            ...
                            <li>
                                <span>
                                    <i class="tio-credit-card-outlined nav-icon"></i>
                                    <strong>{{translate('messages.account_number')}} : </strong>
                                </span>
                                <span>
                            ...
                            <li>
                                <span>
                                    ...
                                    <strong>{{translate('messages.bank_name')}} : </strong>
                                </span>
                                <span>
                                    {{$store->bank_name}}
                                </span>
                            ...
                            <li>
                                <span>
                                    <i class="tio-barcode-outlined nav-icon"></i>
                                    <strong>{{translate('messages.ifsc_code')}} : </strong>
                                </span>
                                <span>
                                    {{$store->ifsc_code}}
                                </span>
