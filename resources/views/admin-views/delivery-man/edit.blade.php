                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="input-label">{{ translate('messages.aadhar_number') }}</label>
                                <input type="text" name="aadhar_number" value="{{ $deliveryMan->aadhar_number }}" 
                                       class="form-control" placeholder="{{ translate('messages.enter_aadhar_number') }}">
                            </div>
                            <div class="form-group">
                                <label class="input-label">{{ translate('messages.aadhar_image') }}</label>
                                <div class="row g-2" id="aadhar-image-container"></div>
                                @if($deliveryMan->aadhar_image)
                                    <span class="badge badge-soft-info">
                                        {{ translate('messages.current_image') }}
                                        <img class="img-fluid rounded border" 
                                             src="{{ asset('storage/delivery-man/' . $deliveryMan->aadhar_image) }}" 
                                             alt="{{ translate('messages.aadhar_image') }}" style="max-width: 100px">
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="input-label">{{ translate('messages.pan_number') }}</label>
                                <input type="text" name="pan_number" value="{{ $deliveryMan->pan_number }}" 
                                       class="form-control" placeholder="{{ translate('messages.enter_pan_number') }}">
                            </div>
                            <div class="form-group">
                                <label class="input-label">{{ translate('messages.pan_image') }}</label>
                                <div class="row g-2" id="pan-image-container"></div>
                                @if($deliveryMan->pan_image)
                                    <span class="badge badge-soft-info">
                                        {{ translate('messages.current_image') }}
                                        <img class="img-fluid rounded border" 
                                             src="{{ asset('storage/delivery-man/' . $deliveryMan->pan_image) }}" 
                                             alt="{{ translate('messages.pan_image') }}" style="max-width: 100px">
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="input-label">{{ translate('messages.bike_registration_number') }}</label>
                                <input type="text" name="bike_registration_number" 
                                       value="{{ $deliveryMan->bike_registration_number }}" 
                                       class="form-control" placeholder="{{ translate('messages.enter_bike_registration') }}">
                            </div>
                            <div class="form-group">
                                <label class="input-label">{{ translate('messages.bike_registration_image') }}</label>
                                <div class="row g-2" id="bike-reg-image-container"></div>
                                @if($deliveryMan->bike_registration_image)
                                    <span class="badge badge-soft-info">
                                        {{ translate('messages.current_image') }}
                                        <img class="img-fluid rounded border" 
                                             src="{{ asset('storage/delivery-man/' . $deliveryMan->bike_registration_image) }}" 
                                             alt="{{ translate('messages.bike_registration') }}" style="max-width: 100px">
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="input-label">{{ translate('messages.bike_insurance_image') }}</label>
                                <div class="row g-2" id="insurance-image-container"></div>
                                @if($deliveryMan->bike_insurance_image)
                                    <span class="badge badge-soft-info">
                                        {{ translate('messages.current_image') }}
                                        <img class="img-fluid rounded border" 
                                             src="{{ asset('storage/delivery-man/' . $deliveryMan->bike_insurance_image) }}" 
                                             alt="{{ translate('messages.bike_insurance') }}" style="max-width: 100px">
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="input-label">{{ translate('messages.driving_license_number') }}</label>
                                <input type="text" name="driving_license_number" 
                                       value="{{ $deliveryMan->driving_license_number }}" 
                                       class="form-control" placeholder="{{ translate('messages.enter_driving_license') }}">
                            </div>
                            <div class="form-group">
                                <label class="input-label">{{ translate('messages.driving_license_image') }}</label>
                                <div class="row g-2" id="license-image-container"></div>
                                @if($deliveryMan->driving_license_image)
                                    <span class="badge badge-soft-info">
                                        {{ translate('messages.current_image') }}
                                        <img class="img-fluid rounded border" 
                                             src="{{ asset('storage/delivery-man/' . $deliveryMan->driving_license_image) }}" 
                                             alt="{{ translate('messages.driving_license') }}" style="max-width: 100px">
                                    </span>
                                @endif
                            </div>
                        </div>
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="input-label">{{ translate('messages.bank_account_number') }}</label>
                                <input type="text" name="bank_account_number" 
                                       value="{{ $deliveryMan->bank_account_number }}" 
                                       class="form-control" placeholder="{{ translate('messages.enter_account_number') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="input-label">{{ translate('messages.bank_name') }}</label>
                                <input type="text" name="bank_name" value="{{ $deliveryMan->bank_name }}" 
                                       class="form-control" placeholder="{{ translate('messages.enter_bank_name') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="input-label">{{ translate('messages.ifsc_code') }}</label>
                                <input type="text" name="ifsc_code" value="{{ $deliveryMan->ifsc_code }}" 
                                       class="form-control" placeholder="{{ translate('messages.enter_ifsc_code') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="input-label">{{ translate('messages.account_type') }}</label>
                                <select name="account_type" class="form-control">
                                    <option value="savings" {{ $deliveryMan->account_type == 'savings' ? 'selected' : '' }}>
                                        {{ translate('messages.savings') }}
                                    </option>
                                    <option value="current" {{ $deliveryMan->account_type == 'current' ? 'selected' : '' }}>
                                        {{ translate('messages.current') }}
                                    </option>
                                </select>
                            </div>
                        </div>
