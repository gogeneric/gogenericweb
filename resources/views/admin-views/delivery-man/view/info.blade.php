...
@endif
                ...
                <div class="row g-3 mt-3">
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="key-val-list-item d-flex gap-3">
                                        <div>{{ translate('messages.aadhar_number') }}</div>
                                        :
                                        <div>{{ $deliveryMan->aadhar_number ?? translate('messages.not_provided') }}</div>
                                    </div>
                                    @if($deliveryMan->aadhar_image)
                                        <div class="mt-3">
                                            <button class="btn p-0" data-toggle="modal" data-target="#aadharImage">
                                                <img class="w-lg-100"
                                                     src="{{ asset('storage/delivery-man/' . $deliveryMan->aadhar_image) }}"
                                                     alt="{{ translate('messages.aadhar_image') }}">
                                            </button>
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="key-val-list-item d-flex gap-3">
                                        <div>{{ translate('messages.pan_number') }}</div>
                                        :
                                        <div>{{ $deliveryMan->pan_number ?? translate('messages.not_provided') }}</div>
                                    </div>
                                    @if($deliveryMan->pan_image)
                                        <div class="mt-3">
                                            <button class="btn p-0" data-toggle="modal" data-target="#panImage">
                                                <img class="w-lg-100"
                                                     src="{{ asset('storage/delivery-man/' . $deliveryMan->pan_image) }}"
                                                     alt="{{ translate('messages.pan_image') }}">
                                            </button>
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div class="col-md-6 mt-4">
                                    <div class="key-val-list-item d-flex gap-3">
                                        <div>{{ translate('messages.bike_registration_number') }}</div>
                                        :
                                        <div>{{ $deliveryMan->bike_registration_number ?? translate('messages.not_provided') }}</div>
                                    </div>
                                    @if($deliveryMan->bike_registration_image)
                                        <div class="mt-3">
                                            <button class="btn p-0" data-toggle="modal" data-target="#bikeRegImage">
                                                <img class="w-lg-100"
                                                     src="{{ asset('storage/delivery-man/' . $deliveryMan->bike_registration_image) }}"
                                                     alt="{{ translate('messages.bike_registration') }}">
                                            </button>
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div class="col-md-6 mt-4">
                                    <div class="key-val-list-item d-flex gap-3">
                                        <div>{{ translate('messages.bike_insurance') }}</div>
                                        :
                                        <div>{{ $deliveryMan->bike_insurance_image ? translate('messages.uploaded') : translate('messages.not_provided') }}</div>
                                    </div>
                                    @if($deliveryMan->bike_insurance_image)
                                        <div class="mt-3">
                                            <button class="btn p-0" data-toggle="modal" data-target="#bikeInsuranceImage">
                                                <img class="w-lg-100"
                                                     src="{{ asset('storage/delivery-man/' . $deliveryMan->bike_insurance_image) }}"
                                                     alt="{{ translate('messages.bike_insurance') }}">
                                            </button>
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div class="col-md-6 mt-4">
                                    <div class="key-val-list-item d-flex gap-3">
                                        <div>{{ translate('messages.driving_license_number') }}</div>
                                        :
                                        <div>{{ $deliveryMan->driving_license_number ?? translate('messages.not_provided') }}</div>
                                    </div>
                                    @if($deliveryMan->driving_license_image)
                                        <div class="mt-3">
                                            <button class="btn p-0" data-toggle="modal" data-target="#drivingLicenseImage">
                                                <img class="w-lg-100"
                                                     src="{{ asset('storage/delivery-man/' . $deliveryMan->driving_license_image) }}"
                                                     alt="{{ translate('messages.driving_license') }}">
                                            </button>
                                        </div>
                                    @endif
                                </div>
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md sessions-card">
                                    <div class="key-val-list-item d-flex gap-3">
                                        <div>{{ translate('messages.account_number') }}</div>
                                        :
                                        <div>{!! $deliveryMan->bank_account_number ?? '&mdash;' !!}</div>
                                    </div>
                                </div>
                                <div class="col-md sessions-card">
                                    <div class="key-val-list-item d-flex gap-3">
                                        <div>{{ translate('messages.bank_name') }}</div>
                                        :
                                        <div>{!! $deliveryMan->bank_name ?? '&mdash;' !!}</div>
                                    </div>
                                </div>
                                <div class="col-md sessions-card">
                                    <div class="key-val-list-item d-flex gap-3">
                                        <div>{{ translate('messages.ifsc_code') }}</div>
                                        :
                                        <div>{!! $deliveryMan->ifsc_code ?? '&mdash;' !!}</div>
                                    </div>
                                </div>
                                <div class="col-md sessions-card">
                                    <div class="key-val-list-item d-flex gap-3">
                                        <div>{{ translate('messages.account_type') }}</div>
                                        :
                                        <div>{!! $deliveryMan->account_type ? translate('messages.'.$deliveryMan->account_type) : '&mdash;' !!}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
